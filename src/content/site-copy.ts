export const siteCopy = {
  ...
  whoItsFor: {
    ...
    paths: [
      ...
      },
      {
        ...
        description:
          "No judgment, no rigid curriculum. Real progress on your schedule.",
      ...
      },
      {
        ...
        description:
          "Theory and ear training tied to the music you're creating.",
  ...
  how: {
    ...
    intro:
      "Weekly one-on-one, built around your music. Miss a live week? A custom video keeps you on track.",
    lessonArc: [
      {
        phase: "Free trial",
        description: "About 30 minutes to map your goals.",
      },
      {
        phase: "Weekly one-on-one",
        description: "Your music, your pace.",
      },
      {
        phase: "Miss a week?",
        description: "Custom video and notes. Progress doesn't stop.",
      },
    ],
  },

  credibility: {
    line: "Students accepted to Juilliard, Berklee, and Manhattan School of Music.",
  },
  ...
  pricing: {
    ...
    subtitle:
      "Start month-to-month, or save with a longer plan. Not sure? Book a free trial.",
    whySubscription:
      "Weekly lessons mean I know your progress and what comes next. Every plan includes the portal and Never Miss A Lesson™.",
    subscribe: "Subscribe",
